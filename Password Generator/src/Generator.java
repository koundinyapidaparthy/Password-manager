...
public class Generator {
    ...
    private void checkStringInUserPassword() {
    	String input1, input2;
    	System.out.print("\nEnter your password");
    	input1 = keyboard.next();
    	System.out.print("\nEnter the string you want to search");
    	input2 = keyboard.next();
    	final checkStringInPassword p = new checkStringInPassword(input1, input2);
    	System.out.println(p.stringExistOrNot());
    }
    ...
    private void printMenu() {
        ...
        System.out.println("Enter 4 - Search A String In Your Password");
